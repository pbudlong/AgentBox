    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 relative flex items-center justify-center overflow-hidden pt-16">
        ...
        <div className="relative z-10 text-center px-8 max-w-4xl">
          ...
          {/* Brand name */}
          <h1 
            className="text-7xl md:text-8xl font-bold mb-6 bg-gradient-to-r from-gradient-from via-gradient-via to-gradient-to bg-clip-text text-transparent"
          ...
          {/* Tagline */}
          <p className="text-2xl md:text-3xl text-muted-foreground mb-12 font-light" data-testid="text-tagline">
