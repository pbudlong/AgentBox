    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <div className="flex-1 flex items-center justify-center pt-16 px-8">
        <div className="max-w-6xl w-full">
          {/* Title */}
          <h1 className="text-5xl md:text-6xl font-bold text-center mb-20 bg-gradient-to-r from-gradient-from via-gradient-via to-gradient-to bg-clip-text text-transparent">
